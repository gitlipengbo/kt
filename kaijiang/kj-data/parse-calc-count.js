...
exports.sxwfz3fs=function(bet, kj){
	return fs(bet, kj.removeFromList(',', 2,5));
}

// 中三单式
exports.sxwfz3ds=function(bet, kj){
	return ds(bet, kj.removeFromList(',', 2,5));
}
...
exports.dsQ2=function(bet, kj){
	return dxds(bet, kj.substr(0,2));
}

// 前三大小单双
exports.dsQ3=function(bet, kj){
	return dxds(bet, kj.substr(0,4));
}
