...
<table cellpadding="0" cellspacing="0" width="320" class="layout">
	...
	<tr>
		<th>充值金额：</th>
		<td><input type="text" name="amount"  value="<?=$rechargeData['amount']?>" /></td>
	</tr>
	<tr>
		<th>实际到账：</th>
		...
		<tr>
		<th>系统赠送：</th>
		<td><input type="text" name="zsAmount" value="<?=$this->iff($this->settings['czzs'],number_format($rechargeData['amount']*($this->settings['czzs']/100.00),2,'.',''),0)?>"/></td>
	</tr>
	<tr>
