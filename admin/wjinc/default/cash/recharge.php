...
<div class="pagemain">
    ...
    <div class="display biao-cont">
        <form action="/index.php/cash/inRecharge/1" method="post" target="ajax" onajax="checkRecharge" call="toCash" dataType="html">
        <?php
     ...
     <tr height=25 class='table_b_tr_b' >
      ...
      <td align="left" ><?php
							...
							<div class="bankchoice">
								<label><input value="<?=$bank['bankId']?>" type="radio" name="mBankId" data-bank='<?=json_encode($bank)?>' style="width:auto;" /><span style="background:url(/<?=$bank['logo']?>);" ></span></label>
							</div>
							<?php } ?>
                            <div class="clear"></div>
                            </td> 
