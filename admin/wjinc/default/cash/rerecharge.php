...
<div class="pagemain">
    ...
    <div class="display biao-cont">
        <form action="/index.php/cash/inRecharge/2" method="post" target="ajax" onajax="checkRecharge" call="toCash" dataType="html">
        <?php
...
<table width="100%" border="0" cellspacing="1" cellpadding="4" class='table_b'>
	...
	<tr height=25 class='table_b_tr_b' >
      ...
      <td align="left" >
	  <p>每天的充值处理时间为：<b style="display:inline;color:#FF0000;">早上 &nbsp 9:30 &nbsp 至  次日凌晨 &nbsp 2:00</b></p>
	  <p></p>
      ...
      <tr height=25 class='table_b_tr_b'>
      <td align="center" class="copys">充值编号：</td>
      <td align="left" ><input name="rechargeId"  value="<?=$args[0]['rechargeId']?>" /><?=$args[0]['rechargeId']?></td>
    </tr>
    
    <tr height=25 class='table_b_tr_b'>
      <td align="center" class="copys">充值金额：</td>
      <td align="left" ><input name="amount" id="ContentPlaceHolder1_txtMoney" value="<?=floatval($args[0]['amount'])?>" /><?=$args[0]['amount']?></td>
    </tr>
	<tr height=25 class='table_b_tr_b'>
