...
<table width="100%" class='table_b'>
	...
	<?php if($data['data']) foreach($data['data'] as $var){ ?>
		<tr>
			...
			<td><a href="/index.php/team/userUpdate/<?=$var['uid']?>" style="color:#333;" target="modal"  width="420" title="修改用户" modal="true" button="确定:dataAddCode|取消:defaultCloseModal">修改</a><br /><a class="caozuo" href="/index.php/team/searchMember?type=2&uid=<?=$var['uid']?>">查看下级</a></td>
            <?php }else{ ?>
