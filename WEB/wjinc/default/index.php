...
<?php $this->display('inc_data_history.php', 0,14); ?></DIV>									
            ...
            if($data) foreach($data as $var){ 
            echo "<li><a href=\"/index.php/notice/view/{$var['id']}\">{$var['title']}</a><em>".date('Y-m-d',$var['addtime'])."</em><span class=\"tipstxt\">{$var['content']}</span></li>";
            } 
            ?>
		...
		<div class="footer-link">
			...
			<div class="g_33">
                ...
                <a href=#>安全中心</a><span></span>
		         <a href="http://api.pop800.com/chat/207842" title="在线客服"  target="_blank">在线客服</a>
                <p class="footer-copyright">&copy;2005-2018 钱柜娱乐 All Rights Reserved</p>
             </div>
		</div>
