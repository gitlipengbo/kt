...
<link href='/skin/main/login.css' rel="stylesheet" type="text/css" />
</head>

<body style="background:url(/images/banner_bg.jpg) center center">

   <img src="/images/index/loginlogo1.png" style="margin-left:100px; margin-top:50px;">
