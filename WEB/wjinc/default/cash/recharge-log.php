...
<div class="pagemain">
    ...
    <div class="display biao-cont">
        ...
        <thead>
            ...
            <?php
                $sql="select a.id,a.rechargeId,a.amount,a.rechargeAmount,a.info,a.state,a.actionTime,b.name as bankName from {$this->prename}member_recharge a left join {$this->prename}bank_list b on b.id=a.mBankId where a.uid={$this->user['uid']} and a.isDelete=0";
            ...
            <tr>
                ...
                <td><?=$this->iff($var['state'], '充值成功', '<span style="color:#653809">正在充值</span>')?></td>
