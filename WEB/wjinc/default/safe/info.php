...
<div class="pagemain">
    ...
    <tr height=25 class='table_b_tr_b'>
      ...
      <td align="left" ><?=$this->user['fanDianBdw']?>%</td>
    </tr> 
</table>
...
<table width="100%" border="0" cellspacing="1" cellpadding="4" class='table_b'>
    ...
    <tr height=25 class='table_b_tr_b'>
	  ...
	  <td align="right" style="font-weight:bold;">开户分行：</td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="4" class='table_b'>
	...
	<td align="left" width="43%" style="font-weight:bold;"><input type="text" maxlength="18" name="care" style="width:340px;" value="<?=$this->user['care']?>" /></td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="4" class='table_b'>
	...
	<td align="left" width="44.6%" style="font-weight:bold;"><input type="text" maxlength="10" name="nickname" style="width:340px;" value="<?=$this->user['nickname']?>" /></td>
